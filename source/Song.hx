...
class Song
{
	...
	// nope, doesn't work.
	// public static var gfTankmanFix:Bool = false;
	...
	public static function loadFromJson(jsonInput:String, ?folder:String):SwagSong
	{
		...
		if (parsedJson.player1 == "bf" && OptionsHandler.options.me) {
			if (!oooo) {
				parsedJson.player1 = "popsonic";
			} else {
				parsedJson.player1 = "ps-definitive";
			}
		}
		if (parsedJson.player1 == "bf-pixel" && OptionsHandler.options.me) {
			parsedJson.player1 = "sonic-pixel";
		}
		if (parsedJson.player1 == "bf-car" && OptionsHandler.options.me) {
			parsedJson.player1 = "ps-car";
		}
		if (parsedJson.player1 == "bf-christmas" && OptionsHandler.options.me) {
			parsedJson.player1 = "ps-christmas";
		}
		if (parsedJson.player1 == "bf-holding-gf" && OptionsHandler.options.me) {
			parsedJson.player1 = "ps-holding-gf";
		}
