	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			...
			case Solo(false) | Solo(true):
				...
				inline bindKeys(Control.RESET, FlxG.save.data.keys.retry);
			...
			case Duo(true):
				inline bindKeys(Control.UP, FlxG.save.data.keys.upp1);
				inline bindKeys(Control.DOWN, FlxG.save.data.keys.downp1);
				inline bindKeys(Control.LEFT, FlxG.save.data.keys.leftp1);
				inline bindKeys(Control.RIGHT, FlxG.save.data.keys.rightp1);
				...
				inline bindKeys(Control.RIGHT_MENU, [D, FlxKey.RIGHT]);
			case Duo(false):
				inline bindKeys(Control.UP, FlxG.save.data.keys.upp2);
				inline bindKeys(Control.DOWN, FlxG.save.data.keys.downp2);
				inline bindKeys(Control.LEFT, FlxG.save.data.keys.leftp2);
				inline bindKeys(Control.RIGHT, FlxG.save.data.keys.rightp2);
