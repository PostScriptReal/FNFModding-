...
class NewCharacterState extends MusicBeatState
{
	...
	function writeCharacters() {
		...
		/*var charList:Array<String> = CoolUtil.coolTextFile(FNFAssets.getText('assets/images/custom_chars/charList.txt'));
		var daChars:String = "bf";
		daChars = charList[Std.parseInt(daChars)] + nameText.text;*/
		trace("parsed");
		...
		//File.saveContent('assets/images/custom_chars/charList.txt', CoolUtil.stringifyText(daChars));
		trace("cool stuff");
		#end
	}
}
