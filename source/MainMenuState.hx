...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			if (cmenu == 'default') {
				FlxG.sound.playMusic(FNFAssets.getSound('assets/music/freakyMenu' + TitleState.soundExt));
				...
				FlxG.sound.playMusic(FNFAssets.getSound('assets/images/custom_menus/' + cmenu + '/music&sounds/freakyMenu' + TitleState.soundExt));
			}
		}
		...
		if (cmenu == 'default') {
			...
			bg = new FlxSprite(-80).loadGraphic('assets/images/custom_menus/' + cmenu + '/main_menus/menuBG.png');
		}
		bg.scrollFactor.x = 0;
		...
		if (cmenu == 'default') {
			...
			magenta = new FlxSprite(-80).loadGraphic('assets/images/custom_menus/' + cmenu + '/main_menus/menuBGMagenta.png');
		}
		...
		if (cmenu == 'default') {
			tex = FlxAtlasFrames.fromSparrow('assets/images/FNF_main_menu_assets.png', 'assets/images/FNF_main_menu_assets.xml');
		} else {
			tex = FlxAtlasFrames.fromSparrow('assets/images/custom_menus/' + cmenu + '/main_menus/FNF_main_menu_assets.png', 'assets/images/custom_menus/' + cmenu + '/main_menus/FNF_main_menu_assets.xml');
		}
